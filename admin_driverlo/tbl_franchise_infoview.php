...
$tbl_franchise_info_view = NULL; // Initialize page object first

class ctbl_franchise_info_view extends ctbl_franchise_info {
	...
	// Page object name
	var $PageObjName = 'tbl_franchise_info_view';
	...
	function __construct() {
		...
		if (@$_GET["fld_franchise_ai_id"] <> "") {
			$this->RecKey["fld_franchise_ai_id"] = $_GET["fld_franchise_ai_id"];
			$KeyUrl .= "&amp;fld_franchise_ai_id=" . urlencode($this->RecKey["fld_franchise_ai_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["fld_franchise_ai_id"] <> "") {
				...
				$this->RecKey["fld_franchise_ai_id"] = $this->fld_franchise_ai_id->QueryStringValue;
			} else {
				$sReturnUrl = "tbl_franchise_infolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbl_franchise_infolist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "tbl_franchise_infolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tbl_franchise_info_view)) $tbl_franchise_info_view = new ctbl_franchise_info_view();

// Page init
$tbl_franchise_info_view->Page_Init();

// Page main
$tbl_franchise_info_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_franchise_info_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tbl_franchise_info_view = new ew_Page("tbl_franchise_info_view");
tbl_franchise_info_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbl_franchise_info_view.PageID; // For backward compatibility

// Form object
var ftbl_franchise_infoview = new ew_Form("ftbl_franchise_infoview");

// Form_CustomValidate event
ftbl_franchise_infoview.Form_CustomValidate = 
...
ftbl_franchise_infoview.ValidateRequired = true;
<?php } else { ?>
ftbl_franchise_infoview.ValidateRequired = false; 
<?php } ?>
...
<?php $tbl_franchise_info_view->ExportOptions->Render("body") ?>
<?php if (!$tbl_franchise_info_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbl_franchise_info_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $tbl_franchise_info_view->ShowPageHeader(); ?>
<?php
$tbl_franchise_info_view->ShowMessage();
?>
<form name="ftbl_franchise_infoview" id="ftbl_franchise_infoview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbl_franchise_info">
<table class="ewGrid"><tr><td>
<table id="tbl_tbl_franchise_infoview" class="table table-bordered table-striped">
...
<?php echo $tbl_franchise_info->fld_franchise_ai_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_franchise_info->fld_name->Visible) { // fld_name ?>
	<tr id="r_fld_name">
		<td><span id="elh_tbl_franchise_info_fld_name"><?php echo $tbl_franchise_info->fld_name->FldCaption() ?></span></td>
...
<?php echo $tbl_franchise_info->fld_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_franchise_info->fld_location->Visible) { // fld_location ?>
	<tr id="r_fld_location">
		<td><span id="elh_tbl_franchise_info_fld_location"><?php echo $tbl_franchise_info->fld_location->FldCaption() ?></span></td>
...
<?php echo $tbl_franchise_info->fld_location->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_franchise_info->fld_rating->Visible) { // fld_rating ?>
	<tr id="r_fld_rating">
		<td><span id="elh_tbl_franchise_info_fld_rating"><?php echo $tbl_franchise_info->fld_rating->FldCaption() ?></span></td>
...
<?php echo $tbl_franchise_info->fld_rating->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_franchise_info->fld_is_active->Visible) { // fld_is_active ?>
	<tr id="r_fld_is_active">
		<td><span id="elh_tbl_franchise_info_fld_is_active"><?php echo $tbl_franchise_info->fld_is_active->FldCaption() ?></span></td>
...
<?php echo $tbl_franchise_info->fld_is_active->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($tbl_franchise_info->fld_created_on->Visible) { // fld_created_on ?>
	<tr id="r_fld_created_on">
		<td><span id="elh_tbl_franchise_info_fld_created_on"><?php echo $tbl_franchise_info->fld_created_on->FldCaption() ?></span></td>
...
<?php echo $tbl_franchise_info->fld_created_on->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbl_franchise_infoview.Init();
</script>
<?php
$tbl_franchise_info_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_franchise_info_view->Page_Terminate();
?>
