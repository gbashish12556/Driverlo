...
$tbl_driver_info_add = NULL; // Initialize page object first

class ctbl_driver_info_add extends ctbl_driver_info {
	...
	// Page object name
	var $PageObjName = 'tbl_driver_info_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["fld_driver_ai_id"] != "") {
				...
				$this->setKey("fld_driver_ai_id", $this->fld_driver_ai_id->CurrentValue); // Set up key
			} else {
				$this->setKey("fld_driver_ai_id", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "tbl_driver_infoview.php")
	...
	function LoadDefaultValues() {
		...
		$this->fld_license_no->CurrentValue = NULL;
		$this->fld_license_no->OldValue = $this->fld_license_no->CurrentValue;
		$this->fld_franchise_id->CurrentValue = NULL;
		$this->fld_franchise_id->OldValue = $this->fld_franchise_id->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// fld_license_no
		$this->fld_license_no->SetDbValueDef($rsnew, $this->fld_license_no->CurrentValue, NULL, FALSE);

		// fld_franchise_id
		$this->fld_franchise_id->SetDbValueDef($rsnew, $this->fld_franchise_id->CurrentValue, NULL, FALSE);
		...
		if ($AddRow) {
			$this->fld_driver_ai_id->setDbValue($conn->Insert_ID());
			$rsnew['fld_driver_ai_id'] = $this->fld_driver_ai_id->DbValue;
		}
		if ($AddRow) {
...
// Create page object
if (!isset($tbl_driver_info_add)) $tbl_driver_info_add = new ctbl_driver_info_add();

// Page init
$tbl_driver_info_add->Page_Init();

// Page main
$tbl_driver_info_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_driver_info_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tbl_driver_info_add = new ew_Page("tbl_driver_info_add");
tbl_driver_info_add.PageID = "add"; // Page ID
var EW_PAGE_ID = tbl_driver_info_add.PageID; // For backward compatibility

// Form object
var ftbl_driver_infoadd = new ew_Form("ftbl_driver_infoadd");

// Validate form
ftbl_driver_infoadd.Validate = function() {
...
ftbl_driver_infoadd.Form_CustomValidate = 
...
ftbl_driver_infoadd.ValidateRequired = true;
<?php } else { ?>
ftbl_driver_infoadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftbl_driver_infoadd.Lists["x_fld_franchise_id"] = {"LinkField":"x_fld_franchise_ai_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_fld_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $tbl_driver_info_add->ShowPageHeader(); ?>
<?php
$tbl_driver_info_add->ShowMessage();
?>
<form name="ftbl_driver_infoadd" id="ftbl_driver_infoadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbl_driver_info">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_tbl_driver_infoadd" class="table table-bordered table-striped">
...
ew_CreateCalendar("ftbl_driver_infoadd", "x_fld_created_on", "%Y/%m/%d %H:%M:%S");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ftbl_driver_infoadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$tbl_driver_info_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_driver_info_add->Page_Terminate();
?>
