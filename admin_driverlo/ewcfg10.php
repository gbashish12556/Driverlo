...
define("EW_PROJECT_NAME", "admin_driverlo", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{EF683EA7-113B-4FD4-A0F1-4B1B7BEBED8D}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'bY7wiDS7WBJ52i0b', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/admin_driverlo.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'driverlo_db', TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "ashish_admin_default", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "driverloashish1234$", TRUE); // Administrator password
...
// User table filters
define("EW_USER_TABLE", "`tbl_admin`",  TRUE);
define("EW_USER_NAME_FILTER", "(`fld_user_name` = '%u')",  TRUE);
