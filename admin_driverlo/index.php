...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'tbl_booking_detail'))
		$this->Page_Terminate("tbl_booking_detaillist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'tbl_coupon_discount'))
			$this->Page_Terminate("tbl_coupon_discountlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'tbl_customer_info'))
			$this->Page_Terminate("tbl_customer_infolist.php");
		if ($Security->AllowList(CurrentProjectID() . 'tbl_driver_info'))
			$this->Page_Terminate("tbl_driver_infolist.php");
		if ($Security->AllowList(CurrentProjectID() . 'tbl_admin'))
		...
		if ($Security->AllowList(CurrentProjectID() . 'tbl_fare_chart'))
			$this->Page_Terminate("tbl_fare_chartlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'tbl_franchise_info'))
