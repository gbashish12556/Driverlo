   ...
   if($_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "127.0.0.1"){
    ...
    define('LOCAL',$_SERVER['HTTP_HOST']);
 	if($_SERVER['HTTP_HOST'] == "127.0.0.1")
   	{
  		define('ROOT_PATH','http://172.0.0.1/Driverlo.in/driverlo_admin_panel/');
   	}
	else
	{
		define('ROOT_PATH','http://localhost/Driverlo.in/driverlo_admin_panel/');
	}
	...
	define('ROOT_PATH','http://driverlo.in/driverlo_admin_panel/');
