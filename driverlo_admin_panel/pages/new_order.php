<?php 
if(loader_session_isset('user_name')){ include_once(ACTION_PATH.'new_order_action.php')?>
...
<script type="text/javascript">
	...
	$(function() {
        ...
        <form id="page_form" action="<?php loader_display(ROOT_PATH."new_order") ?>" method="POST" style="display:none" >
