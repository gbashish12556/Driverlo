<?php 
if(loader_session_isset('user_name')){ include_once(ACTION_PATH.'edit_running_order_action.php'); ?>
<script>
function initializ1() {
            ...
            <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            ...
                            <div class="content">
                                    <form id="edit_form" method="post" class="form-horizontal" action="<?php loader_display(ROOT_PATH."edit_running_order")?>">
                                        <div class="form-row row-fluid">
                                            <div class="span6">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="normal">Pickup Location</label>
                                                    <input class="span8 required" id="pickup_point" name="pickup_point" placeholder="Pickup Location" type="text" value="<?php loader_display($pickup_point)?>" />
                                        ...
                                        <div class="form-row row-fluid">
                                            ...
                                            <div class="span6">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="normal">Franchise</label>
                                                    <div class="span8 controls">  
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span8 controls">  
                                                        <select name='driver' id='driver' class='required' >
                                                                <?php get_selected_driver($booked_driver_id);?>
                                                        </select>
                                                    </div>
                                             </div>
                                            </div>
                                          ...
                                          <div class="span6">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="normal">Estimated Time</label>
                                                     <input class="span8 required" id="estimated_time" name="estimated_time" placeholder="Estimated Time" type="text" value="<?php loader_display($estimated_time)?>" />
                                                </div>
                                             </div>
                                          <div class="span6">
                                                <div class="row-fluid">
