<?php 
if(loader_session_isset('user_name')){  include_once(ACTION_PATH.'create_coupon_discount_action.php');?>
<div id="wrapper">
            ...
            <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            ...
                            <div class="content">
                                    <form id="create_form" method="post" class="form-horizontal" action="<?php loader_display(ROOT_PATH.'create_coupon_discount')?>" >
