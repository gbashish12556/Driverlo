<?php 
if(loader_session_isset('user_name')){  include_once(ACTION_PATH.'edit_completed_order_action.php')?>
<script>
function initializ1() {
                        ...
                        <div class="box">
                            <div class="title">
                                <h4>
                                    ...
                                    <span>Edit Completed Order</span>
                                </h4>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span6">
                                                    ...
                                                    <div class="span8 controls">   
                                                        <select class="required" id="journey_time" name="journey_time">
                                                            <option <?php if("Day Time" == $journey_time){?> selected="selected" <?php }?> value="Day Time" >Day Time</option>
                                                            <option <?php if("Night Time" == $journey_time){?> selected="selected" <?php }?> value="Night Time" >Night Time</option>
                                                        </select>
                                                    </div> 
                                            </div>
                                             <div class="span6">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span8 required" id="total_time" name="total_time" placeholder="Total Duration" type="text" value="<?php loader_display($total_time)?>" />
                                                </div>
                                             </div>
                                        </div>
                                         <div class="form-row row-fluid">
                                            <div class="span6">
                                             ...
                                             <div class="span6">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span8 required" id="total_fare" name="total_fare" placeholder="Total Duration" type="text" value="<?php loader_display($total_fare)?>"  />
                                                </div>
                                             </div>
                                        </div>
