<?php 
if(loader_session_isset('user_name')){  include_once(ACTION_PATH.'cancelled_order_action.php')?>
...
<div id="wrapper">
    ...
    <div id="content" class="clearfix">
                            ...
                            <div class="content noPad clearfix">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                                      <div style="padding-left:10px" >
                                            <form id="search_form" action="<?php loader_display(ROOT_PATH."new_order")?>" method="POST" >
        ...
        <form id="page_form" action="<?php loader_display(ROOT_PATH."cancelled_order") ?>" method="POST" style="display:none" >
