<?php 
if(loader_session_isset('user_name')){ include_once(ACTION_PATH.'edit_fare_chart_action.php')?>
<script>
function initializ1() {
                        ...
                        <div class="box">
                            <div class="title">
                                <h4>
                                    ...
                                    <span>Edit Fare Chart</span>
                                </h4>
                                <a href="#" class="minimize">Minimize</a>
                            </div>
                            <div class="content"> 
                                    <form id="edit_form" method="post" class="form-horizontal" action="<?php loader_display(ROOT_PATH.'edit_fare_chart')?>" >
                                        <div class="form-row row-fluid">
                                            <div class="span6">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text" name="city_lat" style="display:none" value="<?php loader_display($city_lat)?>" />
                                                    <input type="text" name="city_lng" style="display:none" value="<?php loader_display($city_lng)?>" />
                                            ...
                                            <div class="span6">
                                             ...
                                             <div class="span6">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span8 required numeric" name="fare" Placeholder="Fare" type="text" value="<?php loader_display($fare)?>"  />
                                                </div>
                                             </div>
                                        </div>
                                        <div class="form-row row-fluid">
