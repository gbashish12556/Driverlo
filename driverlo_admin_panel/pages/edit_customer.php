<?php 
if(loader_session_isset('user_name')){ include_once(ACTION_PATH.'edit_customer_action.php')?>
<div id="wrapper">
            ...
            <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            ...
                            <div class="content">
                                    <form id="edit_form" method="post" class="form-horizontal" action="<?php loader_display(ROOT_PATH.'edit_customer')?>">
                                            ...
                                            <div class="span6">
                                             ...
                                             <div class="span6">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span8 required"  name="password" Placeholder="Password" type="text" value="<?php loader_display($password)?>"/>
                                                </div>
                                             </div>
                                        </div>                                     
                                        <div class="form-row row-fluid">
