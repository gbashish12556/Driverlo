<?php 
if(loader_session_isset('user_name')){ include_once(ACTION_PATH.'fare_chart_action.php')?>
<div id="wrapper">
    ...
    <div id="content" class="clearfix">
                            ...
                            <div class="content noPad clearfix">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                                      <div style="padding-left:10px" >
                                            <form id="search_form" class="form-horizontal" action="<?php loader_display(ROOT_PATH."fare_chart")?>" method="POST" >
                                               <div class="form-row row-fluid">
                                                    <div class="span12">
                                                       <div class="span2">
                                                            <select name="search_type" class="form-control required" >
                                                                <option value="" >Search By</option>
                                                                <option <?php if("city_name" == $search_type){?> selected="selected" <?php } ?> value="city_name" >City Name</option>
                                                            </select>
                                                        </div>
                                                        <div class="span2">
                                      ...
                                      <div class="content noPad">
                                        ...
                                        <tbody>
                                          <?php loader_display($fare_chart_list)?>
                                        </tbody>
                                    </table>
        ...
        <form id="page_form" action="<?php loader_display(ROOT_PATH."fare_chart") ?>" method="POST" style="display:none" >
