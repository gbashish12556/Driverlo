...
include_once(ACTION_PATH.'coupon_discount_action.php');?>
<div id="wrapper">
                            ...
                            <div class="content noPad clearfix">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                                      <div style="padding-left:10px" >
                                            <form id="search_form" class="form-horizontal"  action="<?php loader_display(ROOT_PATH."coupon_discount")?>" method="POST" >
                                               <div class="form-row row-fluid">
                                                    <div class="span12">
                                                       <div class="span2">
                                                            <select name="search_type" class="form-control required" >
                                                                <option value="" >Search By</option>
                                                                <option <?php if("coupon_code" == $search_type){?> selected="selected" <?php } ?> value="coupon_code" >Coupon Code</option>
                                                            </select>
                                                        </div>
                                                        <div class="span2">
                                      ...
                                      <div class="content noPad">
                                        ...
                                        <thead>
                                         ...
                                         <tbody>
                                          <?php loader_display($coupon_discount_list)?>
                                        </tbody>
                                    </table>
    ...
    ->
        ...
        <form id="page_form" action="<?php loader_display(ROOT_PATH."coupon_discount") ?>" method="POST" style="display:none" >
