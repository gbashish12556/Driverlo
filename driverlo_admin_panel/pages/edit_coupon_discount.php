<?php 
if(loader_session_isset('user_name')){ include_once(ACTION_PATH.'edit_coupon_discount_action.php')?>
<div id="wrapper">
                        ...
                        <div class="box">
                            <div class="title">
                                <h4>
                                    ...
                                    <span>Edit Coupon Discount</span>
                                </h4>
                                <a href="#" class="minimize">Minimize</a>
                            </div>
                            <div class="content">
                                    <form id="edit_form" method="post" class="form-horizontal" action="<?php loader_display(ROOT_PATH.'edit_coupon_discount')?>" >
                                        <div class="form-row row-fluid">
                                            <div class="span6">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="normal">Coupon Code</label>
                                                    <input class="span8 required" id="coupon_code" name="coupon_code" placeholder="Coupon Code" type="text" value="<?php loader_display($coupon_code)?>"  />
                                                </div>
                                            </div>
                                             <div class="span6">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="normal">Discount</label>
                                                    <input class="span8 required numeric" name="coupon_discount" Placeholder="Discount" type="text" value="<?php loader_display($coupon_discount)?>"  />
                                            ...
                                            <div class="span6">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span8 controls">   
                                                        <select class="required" name="is_referal">
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span8 controls">   
                                                        <select class="required" name="is_active">
                                                            <option <?php if("1" == $is_active){?> selected="selected" <?php }?>  value="1" >Yes</option>
                                                            <option <?php if("0" == $is_active){?> selected="selected" <?php }?>   value="0" >No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                             </div>
