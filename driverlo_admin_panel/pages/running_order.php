<?php 
if(loader_session_isset('user_name')){ include_once(ACTION_PATH.'running_order_action.php')?>
                            ...
                            <div class="content noPad clearfix">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                                      <div style="padding-left:10px" >
                                            <form id="search_form" action="<?php loader_display(ROOT_PATH."running_order")?>" method="POST" >
...
<script type="text/javascript">
	...
	$(function() {
        ...
        <form id="page_form" action="<?php loader_display(ROOT_PATH."running_order") ?>" method="POST" style="display:none" >
