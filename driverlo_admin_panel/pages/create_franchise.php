<?php 
if(loader_session_isset('user_name')){ include_once(ACTION_PATH.'create_franchise_action.php');?>
<script>
function initializ1() {
            ...
            <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            ...
                            <div class="content">
                                    <form id="create_form" method="post" class="form-horizontal" action="<?php loader_display(ROOT_PATH.'create_franchise')?>"  >
                                        <div class="form-row row-fluid">
                                            <div class="span6">
                                                <div class="row-fluid">
                                                    <label class="form-label span4" for="normal">Franchise Name</label>
                                                    <input class="span8 required" id="name" name="name" placeholder="Franchise Name" type="text" value="<?php loader_display($name)?>" />
                                                </div>
                                            </div>
                                             <div class="span6">
                                                <div class="row-fluid">
                                        ...
                                        <div class="form-row row-fluid">
                                          ...
                                          <?php loader_set_session('form_session',rand(10,10000));?>
                                           ...
                                           <button type="submit" class="btn btn-info">Create Franchise</button>
                                        </div>
                                    </form>
                                </div>
                         </div>  <!-- End .box -->
